...
# 0 데이터 불러오기
a <- read.csv(paste0(dpath, '공공자전거 이용정보(시간대별)_20.09.csv'))
...
# 0 데이터 불러오기
b <- read.csv(paste0(dpath, '공공자전거 이용정보(시간대별)_20.10.csv'))
...
# 0 데이터 불러오기
a <- read.csv(paste0(dpath, '공공자전거 이용정보(시간대별)_20.11.csv'))
...
# 0 데이터 불러오기
a <- read.csv(paste0(dpath, '공공자전거 이용정보(시간대별)_20.12.csv'))
...
# 0 데이터 불러오기
a <- read.csv(paste0(dpath, '공공자전거 이용정보(시간대별)_21.01.csv'))
...
# 0 데이터 불러오기
a <- read.csv(paste0(dpath, '공공자전거 이용정보(시간대별)_21.2.csv'))
...
# 0 데이터 불러오기
a <- read.csv(paste0(dpath, '공공자전거 이용정보(시간대별)_21.3.csv'))
...
# 0 데이터 불러오기
a <- read.csv(paste0(dpath, '공공자전거 이용정보(시간대별)_21.4.csv'))
...
# 0 데이터 불러오기
a <- read.csv(paste0(dpath, '공공자전거 이용정보(시간대별)_21.5.csv'))
...
write.csv(result, file="20200901_20210630_정아.csv")
